...
import { BOTTLE_SPACE, BOTTLE_WIDTH, BOTTLE_HEIGHT, MAX_BOTTLE_PER_ROW } from './constants';
...
export default class Main {
  ...
  start() {
    ...
    // this.bottle.init(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
  ...
  render() {
    ...
    // // Draw descriptions
    // this.gameInfo.renderGameDescription(ctx);
